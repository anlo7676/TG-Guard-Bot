...
func TestMySQLIntegration(t *testing.T) {
	...
	for _, table := range []string{"bot_groups", "users", "group_members", "group_settings", "list_entries", "keyword_rules", "verification_sessions", "moderation_logs", "punishments", "ai_usage_logs", "admin_audits", "feedback", "update_inbox", "bot_state"} {
