...
v1.10.1 改善安装进度显示、合并重复的软件包安装，并为网络下载增加超时。保留 `/dc` 头像数据中心查询和网页「系统升级」。升级方式与功能边界见 [网页升级与 DC 查询](docs/web-upgrade-and-dc.md)，旧版本安全配置变化见 [安全与升级说明](docs/security-and-upgrade.md)。
